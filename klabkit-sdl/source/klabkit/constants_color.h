...
namespace kkit {
	...
	namespace c {
		...
		constexpr std::size_t COLOR_STYLE_GRAY{ 3 };
		constexpr std::size_t COLOR_STYLE_GREEN{ 4 };
		...
		constexpr SDL_Color COL_GREEN_DARK{ 0x32,0xcd,0x32 };
		constexpr SDL_Color COL_GREEN_PALE{ 0x98,0xfb,0x98 };
		...
		constexpr SDL_Color COL_GRAY{ 216,216,216 };
		constexpr SDL_Color COL_GRAY_DARK{ 159,159,159 };
		...
		constexpr ImVec4 COLI_GREEN_DARK{ sdl_to_imgui(COL_GREEN_DARK) };
		constexpr ImVec4 COLI_GREEN_PALE{ sdl_to_imgui(COL_GREEN_PALE) };
		...
		constexpr ImVec4 COLI_GRAY{ sdl_to_imgui(COL_GRAY) };
		constexpr ImVec4 COLI_GRAY_DARK{ sdl_to_imgui(COL_GRAY_DARK) };
	}
